...
/* DISCLAIMER: This is not the original version of the file! Some things were changed (such as removing encryption in some places) to make it work properly. */
(() => {
    ...
    (t.St = () => {
      ...
      return (
        t.wt(
          ...
          (h.Ct = D("infarto")), // c("?u¾¥ü­¤pú>0¶Uk* ", U) (infarto)
    ...
    F.et === 0 &&
      setTimeout(() => {
        ot.ci(
          ...
          () => {
            it.nh = c("ð9»ûC*K¶ü>÷", "f-<­Ê4ÔÈY¾;¥÷át'{¢P¼'ä");
          }
        );
      }, 3e3);
  }
    ...
    if (
      ...
      if ((this.Lv++, (this.wv += t), 9 > this.wv))
        ...
        12.25 > this.wv
          ...
          : (it.nh = c("¬þÆÞé÷ß\t¿)D[ªt{ÀQáU¢h\\óè¼<ÁÞ+", dc));
  ...
  (t.ul = h),
    ...
    (t.st = (h) => {
      if (ft.bi !== void 0)
        return (
          gh.ka(ft.bi, 0),
          void (gh.Ma && (it.nh = c('_@ê)ÈApÐ1ú?Û"', Jc)))
        );
